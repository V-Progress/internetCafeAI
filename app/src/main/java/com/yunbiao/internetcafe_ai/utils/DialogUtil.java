...
public class DialogUtil {
    ...
    public void showSuccessTip(Activity activity, String title, String msg) {
        showSuccessTip(activity,title,msg,null);
    }

    public void showSuccessTip(Activity activity, String title, String msg, final Runnable runnable){
