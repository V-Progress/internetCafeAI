...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    private CameraHelper(CameraHelper.Builder builder) {
        ...
        Log.e(TAG, "CameraHelper: 预览：" + previewDisplayView.getMeasuredWidth() + " --- " + previewDisplayView.getMeasuredHeight());
        Log.e(TAG, "CameraHelper: 摄像头ID: " + specificCameraId);
        Log.e(TAG, "CameraHelper: 回调：" + cameraListener);
        Log.e(TAG, "CameraHelper: 方向：" + rotation);
        Log.e(TAG, "CameraHelper: 方向2：" + additionalRotation);
        Log.e(TAG, "CameraHelper: 预览尺寸：" + previewViewSize);
        Log.e(TAG, "CameraHelper: 预览尺寸2：" + specificPreviewSize);
    ...
    public void start() {
        synchronized (this) {
            ...
            Log.e(TAG, "start: 当前开启摄像头Id：" + mCameraId);
...
//            displayOrientation = getCameraOri(rotation);
            Log.e(TAG, "run: 摄像头方向：" + displayOrientation);
            ...
            try {
                ...
                mCamera.setPreviewCallback(CameraHelper.this);
